...
class TestTrainer(unittest.TestCase):
    ...
    simple_config = dict(optimizer = 'Adam',
    ...
    def test_accelerator(self):
        ...
        params = ['cpu']
        acceleator_expected = [Accelerator.cpu, Accelerator.gpu, Accelerator.mgpu, Accelerator.tpu]
    ...
    def test_default_strategy(self):
        ...
        if tf.config.list_physical_devices('GPU'):
            ...
            expected_strategies.extend([tf.distribute.OneDeviceStrategy,tf.distribute.MirroredStrategy])
    ...
    def test_custom_model_clone_model(self):
        ...
        model = CModel()
        trainer = Trainer(self.simple_config, 
                            model,
                            train_dataset = self.train_dataset,
                            val_dataset = self.dev_dataset)
...
if __name__ == '__main__':
    ...
    # trainer = Trainer(TestTrainer.simple_config, 
    #         TestTrainer.simple_model, 
    #         train_dataset = TestTrainer.train_dataset, 
    #         val_dataset = TestTrainer.dev_dataset)

    # print(trainer.config)


    custom_module = 'schema/schema.py'
    correct_path = os.path.abspath(os.path.join(os.path.dirname(__file__),os.path.pardir, custom_module))
    print(correct_path)
    unittest.main()
